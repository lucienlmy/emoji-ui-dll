...
- [项目结构](#项目结构)
- [编译步骤](#编译步骤)
  - [1. 使用 Visual Studio（推荐）](#1-使用-visual-studio推荐)
  - [2. 使用命令行（MSBuild）](#2-使用命令行msbuild)
- [API 文档](#api-文档)
  - [创建窗口](#创建窗口)
  - [创建 Emoji 按钮（字节集）](#创建-emoji-按钮字节集)
  - [设置按钮点击回调](#设置按钮点击回调)
  - [设置窗口大小改变回调](#设置窗口大小改变回调)
  - [设置窗口被关闭回调](#设置窗口被关闭回调)
  - [设置窗口图标](#设置窗口图标)
  - [设置窗口标题](#设置窗口标题)
  - [编辑框](#编辑框)
    - [创建编辑框（含文本垂直居中）](#创建编辑框含文本垂直居中)
    - [设置编辑框垂直居中（创建后修改）](#设置编辑框垂直居中创建后修改)
    - [设置编辑框按键回调](#设置编辑框按键回调)
  - [复选框（CheckBox）](#复选框checkbox)
    ...
    - [显示/隐藏复选框](#显示隐藏复选框)
    - [设置复选框文本](#设置复选框文本)
    - [设置复选框位置和大小](#设置复选框位置和大小)
    - [复选框样式说明](#复选框样式说明)
  - [进度条（ProgressBar）](#进度条progressbar)
    - [创建进度条](#创建进度条)
    - [设置进度条值](#设置进度条值)
    - [获取进度条值](#获取进度条值)
    - [设置进度条不确定模式](#设置进度条不确定模式)
    - [设置进度条颜色](#设置进度条颜色)
    - [设置进度条回调](#设置进度条回调)
    - [启用/禁用进度条](#启用禁用进度条)
    - [显示/隐藏进度条](#显示隐藏进度条)
    - [设置进度条位置和大小](#设置进度条位置和大小)
    - [设置是否显示百分比文本](#设置是否显示百分比文本)
    - [进度条样式说明](#进度条样式说明)
  - [运行消息循环](#运行消息循环)
  - [图片框（PictureBox）](#图片框picturebox)
    - [创建图片框](#创建图片框)
    - [从文件加载图片](#从文件加载图片)
    - [从内存加载图片](#从内存加载图片)
    - [清除图片](#清除图片)
...
- [列表框控件 (ListBox)](#列表框控件-listbox)
  ...
  - [启用/禁用列表框](#启用禁用列表框)
  - [显示/隐藏列表框](#显示隐藏列表框)
  - [设置列表框位置和大小](#设置列表框位置和大小)
  - [列表框特性](#列表框特性)
  - [完整示例](#完整示例)
- [分组框控件 (GroupBox)](#分组框控件-groupbox)
  - [创建分组框](#创建分组框)
  - [添加子控件到分组框](#添加子控件到分组框)
  - [从分组框移除子控件](#从分组框移除子控件)
  - [设置分组框标题](#设置分组框标题)
  - [启用/禁用分组框](#启用禁用分组框)
  - [显示/隐藏分组框](#显示隐藏分组框)
  - [设置分组框位置和大小](#设置分组框位置和大小)
  - [分组框特性](#分组框特性)
  - [完整示例](#完整示例-1)
- [组合框控件 (ComboBox)](#组合框控件-combobox)
  - [创建组合框](#创建组合框)
  - [添加组合框项](#添加组合框项)
  - [获取/设置选中项索引](#获取设置选中项索引)
  - [获取/设置编辑框文本](#获取设置编辑框文本)
  - [设置组合框回调](#设置组合框回调)
  - [其他组合框API](#其他组合框api)
  - [组合框特性](#组合框特性)
- [热键控件 (HotKey Control)](#热键控件-hotkey-control)
  - [创建热键控件](#创建热键控件)
  - [获取/设置热键值](#获取设置热键值)
  - [清除热键](#清除热键)
  - [设置热键回调](#设置热键回调)
  ...
  - [热键控件特性](#热键控件特性)
  - [注意事项](#注意事项)
- [DataGridView 表格控件](#datagridview-表格控件)
  - [创建表格](#创建表格)
  - [列管理](#列管理)
  - [行管理](#行管理)
  - [单元格操作](#单元格操作)
...
- [布局管理器](#布局管理器)
  ...
  - [移除布局管理器](#移除布局管理器)
  - [布局类型](#布局类型)
    - [1. 水平流式布局 (LAYOUT_FLOW_H = 1)](#1-水平流式布局-layout_flow_h--1)
    - [2. 垂直流式布局 (LAYOUT_FLOW_V = 2)](#2-垂直流式布局-layout_flow_v--2)
    - [3. 网格布局 (LAYOUT_GRID = 3)](#3-网格布局-layout_grid--3)
    - [4. 停靠布局 (LAYOUT_DOCK = 4)](#4-停靠布局-layout_dock--4)
  - [布局常量](#布局常量)
  - [停靠位置常量](#停靠位置常量)
  - [布局管理器特性](#布局管理器特性)
- [主题系统](#主题系统)
  - [从 JSON 加载主题](#从-json-加载主题)
  - [从文件加载主题](#从文件加载主题)
  - [设置主题](#设置主题)
  - [设置暗色模式](#设置暗色模式)
  - [获取主题颜色](#获取主题颜色)
...
- [完整控件列表](#完整控件列表)
- [常见问题 (FAQ)](#常见问题-faq)
  - [Q: 为什么 Emoji 在易语言 IDE 中显示为乱码？](#q-为什么-emoji-在易语言-ide-中显示为乱码)
  - [Q: 如何在窗口大小改变时自动调整控件位置？](#q-如何在窗口大小改变时自动调整控件位置)
  - [Q: 表格控件如何处理大数据量？](#q-表格控件如何处理大数据量)
  - [Q: 如何实现暗色模式切换？](#q-如何实现暗色模式切换)
  - [Q: 控件的颜色参数格式是什么？](#q-控件的颜色参数格式是什么)
  - [Q: 如何正确释放资源？](#q-如何正确释放资源)
- [性能优化建议](#性能优化建议)
- [易语言调用示例](#易语言调用示例)
- [技术细节](#技术细节)
- [依赖项](#依赖项)
